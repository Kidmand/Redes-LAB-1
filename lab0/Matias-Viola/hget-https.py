...
PREFIX = "https://"
HTTPS_PORT = 443   # 80 es el puerto por convencion para HTTP, 443 para HTTPS
...
def get_response(connection, filename):
    ...
    print('-'*46+'Pregunta'+'-'*46)
    print("Por que al ejecutar la linea aprox 196 'header = read_line(connection)' me devuelve HTTP en vez de HTTPS en el header? \nconnection = {} \nheader = {}".format(connection, header))
    print('-'*100)
