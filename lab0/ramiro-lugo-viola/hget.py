...
def connect_to_server(server_name):
    ...
    try:
        ...
        sys.stderr.write("No se encontro la IP de la direccion proporcionada\n")
        raise e
    # Informar al usuario de la direccion IP obtenida
    ...
    try:
        ...
        sys.stderr.write("El servidor en {ip_address}:{HTTP_PORT} rechazó la conexión.\n")
        raise e
